...
class Scene:
    ...
    def __init__(self,
        ...
        if load_iteration:
            ...
            print("Loading trained model at iteration {}".format(
                self.loaded_iter))

        self.train_cameras = {}
        self.test_cameras = {}

        if camera_type == "polycam":

            scene_info = sceneLoadTypeCallbacks["Polycam"](args.source_path, )
        ...
        if not self.loaded_iter:
            ...
            with open(os.path.join(self.model_path, "cameras.json"),
                      'w') as file:
